...
from conversation import Conversation, IterationBudget, Message, ToolCall
import tools
from agent import generate_with_failover
...
class AgentSession:
    def __init__(self, cwd: str, model_ref: str = "", fallbacks: Optional[List[str]] = None,
        ...
        self.cwd = cwd
        self.model_ref = model_ref or os.getenv("MODEL", "gemini:gemini-3-flash")
        self.fallbacks = fallbacks or [
            m for m in os.getenv("FALLBACK_MODELS", "").split(",") if m.strip()
        ]
